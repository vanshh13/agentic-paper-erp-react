    ...
    <div className="card-surface p-6 border border-[var(--border)]">
      <div className="space-y-4">
        ...
        <div>
          ...
          <p className="text-xs text-muted-foreground">Highest value customers this month</p>
        </div>
              ...
              <div key={customer.name} className="flex items-center justify-between py-2 border-b border-[var(--border)] last:border-0">
                <div className="flex items-center gap-2 flex-1">
                  <div className="w-8 h-8 rounded-full bg-purple-500/20 flex items-center justify-center flex-shrink-0">
                    <span className="text-xs font-semibold text-purple-600 dark:text-purple-400">{customer.customerCode}</span>
                  </div>
                  <div>
                ...
                <div className="text-right ml-2">
                  <p className="text-sm font-semibold text-foreground">{customer.revenue}</p>
                  <p className="text-xs text-emerald-600 dark:text-emerald-400">{customer.growth}</p>
                </div>
              </div>
            )
          })}
