  ...
  return (
    <div className="space-y-6 pb-10 text-[oklch(0.95_0_0)] w-full px-4 sm:px-6 lg:px-8">
      ...
      <div className="space-y-2">
        <div className="flex flex-wrap items-center gap-3 justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-3xl md:text-4xl font-bold text-[oklch(0.98_0_0)]">Sales Orders</h1>
              <p className="text-[oklch(0.70_0_0)] text-sm md:text-base mt-1">Manage and track all sales orders</p>
            </div>
          </div>
      ...
      <div className="card-surface rounded-xl border border-[var(--border)] p-4 md:p-6 space-y-4">
        <div className="flex flex-wrap gap-3 items-center text-[oklch(0.75_0_0)] text-sm font-medium">
          <span className="text-base md:text-lg text-[oklch(0.90_0_0)]">Filters</span>
        ...
        <div className="flex flex-wrap gap-3 items-center">
          ...
          <button className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-[oklch(0.30_0_0)] border border-[var(--border)] text-[oklch(0.85_0_0)] hover:text-[oklch(0.98_0_0)] hover:border-indigo-500/60 transition-colors text-sm">
      ...
      <div className="card-surface rounded-xl border border-[var(--border)] overflow-hidden">
        <div className="px-4 md:px-6 py-3 border-b border-[var(--border)] flex items-center justify-between">
          <div>
            <h3 className="text-base md:text-lg font-semibold text-[oklch(0.95_0_0)]">Orders ({filteredOrders.length})</h3>
            <p className="text-[oklch(0.65_0_0)] text-xs md:text-sm">Most recent orders first</p>
          </div>
        </div>
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-[var(--border)] bg-[oklch(0.28_0_0)]">
                <th className="px-6 py-4 text-left text-xs font-semibold text-[oklch(0.75_0_0)] uppercase tracking-wider">Order Number</th>
                <th className="px-6 py-4 text-left text-xs font-semibold text-[oklch(0.75_0_0)] uppercase tracking-wider">Status</th>
                <th className="px-6 py-4 text-left text-xs font-semibold text-[oklch(0.75_0_0)] uppercase tracking-wider">Payment</th>
                <th className="px-6 py-4 text-left text-xs font-semibold text-[oklch(0.75_0_0)] uppercase tracking-wider">Amount</th>
                <th className="px-6 py-4 text-left text-xs font-semibold text-[oklch(0.75_0_0)] uppercase tracking-wider">Delivery Date</th>
                <th className="px-6 py-4 text-left text-xs font-semibold text-[oklch(0.75_0_0)] uppercase tracking-wider">Created</th>
            ...
            <tbody>
              {filteredOrders.map((order) => (
                ...
                >
                  <td className="px-6 py-4 text-sm font-medium text-[oklch(0.95_0_0)]">{order.number}</td>
                  ...
                  <td className="px-6 py-4 text-sm text-[oklch(0.90_0_0)]">{order.amount}</td>
                  <td className="px-6 py-4 text-sm text-[oklch(0.85_0_0)]">{order.deliveryDate}</td>
                  <td className="px-6 py-4 text-sm text-[oklch(0.85_0_0)]">{order.createdAt}</td>
                  <td className="px-6 py-4 text-sm">
        ...
        {filteredOrders.length === 0 && (
          <div className="py-12 text-center text-[oklch(0.65_0_0)] text-sm">No orders found</div>
        )}
      </div>
    </div>
  )
