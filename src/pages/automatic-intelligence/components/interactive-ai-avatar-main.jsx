  ...
  return (
    <div className="w-full flex flex-col items-center justify-center py-2 gap-3">
      <div className="relative w-32 h-32 md:w-40 md:h-40">
        {/* Glow effect scaled down slightly via blur-2xl */}
      ...
      {/* AI Agent Text - Scaled down to match smaller logo */}
      <div className="text-center px-4">
        <p className="text-xs md:text-xs font-medium text-[oklch(0.85_0_0)] tracking-wide opacity-80">
          Hey {greeting},
        </p>
        <p className="text-sm md:text-sm font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-cyan-400 to-emerald-400 tracking-tight mt-0.5">
